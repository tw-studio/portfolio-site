/* eslint no-dupe-keys: 'off', no-multi-str: 'off' */
...
export const normalize = [
  ...
  /*
    ...
    *   4.  Use Tailwind's default "normal" line-height so the user isn't forced
    ...
    */
    ...
    /**
     * Fix Firefox displaying alt text while images load
     */
